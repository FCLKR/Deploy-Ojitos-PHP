...
@section('content')
                        ...
                        <div class="mt-4 bg-white dark:bg-gray-800 shadow-sm rounded-lg divide-y dark:divide-gray-900">
                            <div class="container relative">
                                <div class="flex sm:justify-between h-8">
                                    <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                                        @if(count($misSolicitudes) > 0){{ __('¡Tus solicitudes!') }}@else {{ __('¡Aqui apareceran las solicitudes de adopción que realices!') }}@endif
                                    </h2>
                                </div>
                            </div>
                            @if(count($misSolicitudes) > 0)
                                <div id="tableContainer" style="display: block;">
                                    <table id="dataTable">
                                        <thead>
                                        <tr>
                                            <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Imagen</th>
                                            ...
                                            <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Fecha de solicitud</th>
                                            <th scope="col" class="esp text-center">Especie</th>
                                            <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Raza</th>
                                            <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Edad (Meses)</th>
                                            <th scope="col" class="obs text-center">Observaciones</th>
                                            <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Estado Solicitud</th>
                                        </tr>
                                        </thead>
                                        <tbody>
    ...
    <div id="confirmationModalDelete">
        <div id="confirmationBox">
            <h2 class="con">Confirmación</h2>
            <p class="parcon">¿Estás seguro de que deseas eliminar?</p>
    ...
    <script>
        ...
        //****FIN conclusión adopción**********

        //**MODAL DE INFORMACIÓN OBTENER VACUNA
        ...
        //***FIN MODAL DE INFORMACIÓN OBTENER VACUNA********
