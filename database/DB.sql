...
CREATE DATABASE IF NOT EXISTS `ojitos_db1` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `ojitos_db1`;
...
CREATE TABLE IF NOT EXISTS `adopcion` (
  ...
  `adoption_status` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `animales_en_adopcion` (
  ...
  `nombreAnimaladopocion` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `especie_Animal` enum('Perro','Gato') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `raza` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `age` int DEFAULT NULL,
  `observacionesAnimal` text COLLATE utf8mb4_general_ci,
  `estadoSolicitud` enum('Disponible','Solicitado','Adoptado') COLLATE utf8mb4_general_ci DEFAULT 'Disponible',
  `img` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `animal_vacuna` (
  ...
  `adquisicion` enum('Sin_Aplicar','Aplicada') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Sin_Aplicar',
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
...
DELIMITER //
CREATE PROCEDURE `AprobacionAdoptar`(
...
DELIMITER //
CREATE PROCEDURE `comprarVacuna`(
...
DELIMITER //
CREATE PROCEDURE `concluirAdopcion`(
	IN `in_date` DATE,
	IN `p_id_animaladopcion` INT,
	IN `p_status` VARCHAR(50)
)
...
DELIMITER //
CREATE PROCEDURE `encontrar_vacunas_modal`(
	IN `e_id_animal` INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `estadosolicitudAnimales`(
	IN `p_id` INT,
...
especificacion varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
usuarios_id_usuario int NOT NULL,
idAnimal int DEFAULT NULL,
metodoPago varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
created_at datetime DEFAULT NULL,
updated_at datetime DEFAULT NULL,
...
descriptionF varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
created_at datetime DEFAULT NULL,
updated_at datetime DEFAULT NULL,
...
pet_sex enum('Macho','Hembra') COLLATE utf8mb4_general_ci NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=15033 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
DELIMITER //
CREATE PROCEDURE rechazarAdopcion(
IN in_idAnimal INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE SearchP_Vacunas(
IN in_idAnimal INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE Search_VN_Sin_Aplicar(
IN in_idAnimal INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE updateStatusAnimalList(
...
DELIMITER //
CREATE PROCEDURE updateTablesForCompra(
IN idAnimal INT
)
BEGIN
UPDATE adopcion
...
estado enum('Activo','Inactivo','Suspendido') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Activo',
age int NOT NULL,
updated_at datetime DEFAULT NULL,
created_at datetime DEFAULT NULL,
...
especie enum('Perro','Gato') COLLATE utf8mb4_general_ci DEFAULT NULL,
created_at datetime DEFAULT NULL,
updated_at datetime DEFAULT NULL,
PRIMARY KEY (id)
